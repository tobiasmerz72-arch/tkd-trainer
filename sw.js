const CACHE_NAME="tobis-taekwondo-academy-v4-20260728";
const FILES=["./","./index.html","./styles.css","./app.js","./manifest.json","./common_terms.json","./techniques.json","./theory.json","./assets/tkd-hero.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
